...
class ServiceFormReview extends StatelessWidget {
  const ServiceFormReview({Key? key}) : super(key: key);
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            reviewItem(title: "نوع الخدمة", value: "${FormHelper.serviceType}"),
                            reviewItem(title: "نوع الوحدة السكنية", value: "${FormHelper.buildingType}"),
                            newDivider(),
