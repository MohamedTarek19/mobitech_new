...
class InHomeServiceSelection extends StatefulWidget {
  const InHomeServiceSelection({Key? key}) : super(key: key);

  @override
  State<InHomeServiceSelection> createState() => _InHomeServiceSelectionState();
}

class _InHomeServiceSelectionState extends State<InHomeServiceSelection> {
  ...
  Widget build(BuildContext context) {
    ...
    return Directionality(
      ...
      child: MainContainer(
          widget: Scaffold(
            appBar: CustomAbbBar("الأعمال المنزلية", context),
            body: Form(
              key: formK,
              child: Column(
                      ...
                      child: DropdownButton(
                        ...
                        selectedItemBuilder: (BuildContext context) {
                          return items.map((value) {
                            return Align(
                              ...
                              child: Text(MHelper.dropdownvalueIH),
                            );
                          }).toList();
                        },
                        onChanged: (String? newValue) {
                          setState(() {
                            ...
                            MHelper.dropdownvalueIH = newValue.toString();
                          });
                        },
                      ),
                    ),
                    ...
                    child: Container(
                      ...
                      child: CustomBtn(
                          ...
                          action: () async {
                            ...
                            Navigation.puchNav(InHomeForm(), context);
                          }),
                    ),
                  )
                ],
